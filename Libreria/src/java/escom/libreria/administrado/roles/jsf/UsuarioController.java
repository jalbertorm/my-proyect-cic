...
import escom.libreria.administrado.roles.ejb.UsuarioFacade;
...
public class UsuarioController {
    ...
    @EJB private escom.libreria.administrado.roles.ejb.UsuarioFacade ejbFacade;
    ...
    public String prepareView(Usuario usuario) {
        current = usuario;//(Usuario)getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(("UsuarioCreated"));
            return "/usuario/List";//prepareCreate();
        } catch (Exception e) {
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(("UsuarioUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    public String destroy(Usuario usuario) {
        ...
        JsfUtil.addSuccessMessage("Elemento eliminado");
        return "/usuario/List";
    }
